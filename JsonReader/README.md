...
|---------|------------------|------------|
| View metadata | ✅ Instant | ✅ Via image preview |
| Extract parameters | ✅ Automatic | ❌ Manual inspection |
| After Effects integration | ✅ Native | ❌ Not available |
| Copy API prompt | ✅ One click | ✅ Via Dev mode |
| No app switching | ✅ Yes | ❌ Must open ComfyUI |
| Batch comparison | ✅ Select layers | ❌ One at a time |

## 🔄 Integration with Image2Image Panel
